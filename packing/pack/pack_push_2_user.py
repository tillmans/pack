...
def pushAPN(deviceToken,type, orderId):
    ...
    if type == '1000':
        template.setPushInfo("查看",0,"您的订单准备完毕","",_payLoad,"","","",1)
    elif type == '1001':
        template.setPushInfo("查看",0,"您的订单取消了","",_payLoad,"","","",1)
    elif type == '1002':
        template.setPushInfo("查看",0,"您的订单已经完成","",_payLoad,"","","",1)
